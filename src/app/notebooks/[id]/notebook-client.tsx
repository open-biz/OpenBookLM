...
export function NotebookClient({
  ...
  return (
    <div className="flex h-[calc(100vh-57px)]">
      ...
      <div
        className={cn(
          "border-r border-[#2A2A2A] bg-[#1C1C1C] transition-all duration-300",
          showSourcesSidebar ? "w-72" : "w-0"
        )}
      >
      ...
      <div
        className={cn(
          "border-l border-[#2A2A2A] bg-[#1C1C1C] transition-all duration-300",
          showAudioSidebar ? "w-80" : "w-0"
        )}
      >
        <div className="relative h-full">
          <div
            className={cn("p-4 overflow-hidden", !showAudioSidebar && "hidden")}
          >
